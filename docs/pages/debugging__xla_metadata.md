...
- [ .md](../_sources/debugging/xla_metadata.md "Download source file")
-  .pdf
...
- [Attaching XLA Metadata with `set_xla_metadata`](#)
- [What is XLA Metadata?](#what-is-xla-metadata)
- [Usage](#usage)
  - [Tagging Individual Operations](#tagging-individual-operations)
  - [Tagging a Block of Code with a Context Manager or Decorator](#tagging-a-block-of-code-with-a-context-manager-or-decorator)
- [Interaction with JAX Transformations](#interaction-with-jax-transformations)
  - [Strengths and Limitations of `set_xla_metadata`](#strengths-and-limitations-of-set-xla-metadata)
    - [Strengths](#strengths)
    - [Limitations](#limitations)

# Attaching XLA Metadata with `set_xla_metadata`[\#](#attaching-xla-metadata-with-set-xla-metadata "Link to this heading")
...
# What is XLA Metadata?[\#](#what-is-xla-metadata "Link to this heading")
...
## Tagging Individual Operations[\#](#tagging-individual-operations "Link to this heading")
...
## Tagging a Block of Code with a Context Manager or Decorator[\#](#tagging-a-block-of-code-with-a-context-manager-or-decorator "Link to this heading")
...
# Interaction with JAX Transformations[\#](#interaction-with-jax-transformations "Link to this heading")
...
## Strengths and Limitations of `set_xla_metadata`[\#](#strengths-and-limitations-of-set-xla-metadata "Link to this heading")
...
- **Forward-pass only:** Metadata is not currently automatically propagated to gradients *when tagging individual operations* in the backward pass. A `custom_vjp` must be used in order to tag gradients in this case. See above for an example.

- **Liable to change**: `set_xla_metadata` is an experimental feature and its API is subject to change.

[](checkify_guide.html "previous page")

previous

The `checkify` transformation

[](../transfer_guard.html "next page")
