...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gumbel_r.sf.rst "Download source file")
-  .pdf
...
- [`sf()`](#jax.scipy.stats.gumbel_r.sf)

# jax.scipy.stats.gumbel_r.sf[\#](#jax-scipy-stats-gumbel-r-sf "Link to this heading")

jax.scipy.stats.gumbel_r.sf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gumbel_r.py#L197-L229)[\#](#jax.scipy.stats.gumbel_r.sf "Link to this definition")  
Gumbel Distribution (Right Skewed) survival function.

JAX implementation of [`scipy.stats.gumbel_r`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.gumbel_r.html#scipy.stats.gumbel_r "(in SciPy v1.19.0.dev)") `sf`.
...
[](jax.scipy.stats.gumbel_r.logcdf.html "previous page")

previous

jax.scipy.stats.gumbel_r.logcdf

[](jax.scipy.stats.gumbel_r.logsf.html "next page")
