...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gumbel_l.cdf.rst "Download source file")
-  .pdf
...
- [`cdf()`](#jax.scipy.stats.gumbel_l.cdf)

# jax.scipy.stats.gumbel_l.cdf[\#](#jax-scipy-stats-gumbel-l-cdf "Link to this heading")

jax.scipy.stats.gumbel_l.cdf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gumbel_l.py#L132-L159)[\#](#jax.scipy.stats.gumbel_l.cdf "Link to this definition")  
Gumbel Distribution (Left Skewed) cumulative density function.

JAX implementation of [`scipy.stats.gumbel_l`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.gumbel_l.html#scipy.stats.gumbel_l "(in SciPy v1.19.0.dev)") `cdf`.
...
[](jax.scipy.stats.gumbel_l.pdf.html "previous page")

previous

jax.scipy.stats.gumbel_l.pdf

[](jax.scipy.stats.gumbel_l.logcdf.html "next page")
