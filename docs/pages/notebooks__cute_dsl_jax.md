...
- [ .ipynb](../_sources/notebooks/cute_dsl_jax.ipynb "Download source file")
-  .pdf
...
- [The CuTe mental model](#the-cute-mental-model)
- [Hardware and software requirements](#hardware-and-software-requirements)
- [Install CuTe DSL and import dependencies](#install-cute-dsl-and-import-dependencies)
- [Defining kernels](#defining-kernels)
- [Basic kernel: vector add](#basic-kernel-vector-add)
  - [JAX integration via `cutlass_call`](#jax-integration-via-cutlass-call)
- [SAXPY: scalar parameters in kernels](#saxpy-scalar-parameters-in-kernels)
- [Deep learning activations: ReLU and fused bias+ReLU](#deep-learning-activations-relu-and-fused-bias-relu)
  - [ReLU](#relu)
  - [JAX wrapper: ReLU](#jax-wrapper-relu)
  - [Fused bias+ReLU](#fused-bias-relu)
- [Advanced: Tiled GEMM](#advanced-tiled-gemm)
- [Performance comparison](#performance-comparison)
- [Multi-GPU: sharding CUTLASS kernels via `jax.shard_map`](#multi-gpu-sharding-cutlass-kernels-via-jax-shard-map)
  - [How sharding works](#how-sharding-works)
- [Exporting CUTLASS kernels with `jax.export`](#exporting-cutlass-kernels-with-jax-export)
  - [What `jax.export` gives you](#what-jax-export-gives-you)
  - [How it works](#how-it-works)
  - [Exporting with symbolic shapes](#exporting-with-symbolic-shapes)
- [Summary](#summary)

# Writing High-Performance GPU Kernels with CuTe DSL and JAX[\#](#writing-high-performance-gpu-kernels-with-cute-dsl-and-jax "Link to this heading")
...
## The CuTe mental model[\#](#the-cute-mental-model "Link to this heading")
...
## Hardware and software requirements[\#](#hardware-and-software-requirements "Link to this heading")
...
## Install CuTe DSL and import dependencies[\#](#install-cute-dsl-and-import-dependencies "Link to this heading")
...
## Defining kernels[\#](#defining-kernels "Link to this heading")
...
We show the executable kernel definitions inline in the notebook. At the same time, for robustness and reproducibility, we keep equivalent definitions in a separate .py module ([cute_dsl_jax_kernels.py](../_downloads/6deefc110884b438862669ecf511d8e7/cute_dsl_jax_kernels.py)).

Here, we import the pre-written kernel launch functions from [cute_dsl_jax_kernels.py](../_downloads/6deefc110884b438862669ecf511d8e7/cute_dsl_jax_kernels.py).
...
## Basic kernel: vector add[\#](#basic-kernel-vector-add "Link to this heading")
...
### JAX integration via `cutlass_call`[\#](#jax-integration-via-cutlass-call "Link to this heading")
...
## SAXPY: scalar parameters in kernels[\#](#saxpy-scalar-parameters-in-kernels "Link to this heading")
...
## Deep learning activations: ReLU and fused bias+ReLU[\#](#deep-learning-activations-relu-and-fused-bias-relu "Link to this heading")

### ReLU[\#](#relu "Link to this heading")
...
### JAX wrapper: ReLU[\#](#jax-wrapper-relu "Link to this heading")
...
### Fused bias+ReLU[\#](#fused-bias-relu "Link to this heading")
...
## Advanced: Tiled GEMM[\#](#advanced-tiled-gemm "Link to this heading")
...
## Performance comparison[\#](#performance-comparison "Link to this heading")
...
## Multi-GPU: sharding CUTLASS kernels via `jax.shard_map`[\#](#multi-gpu-sharding-cutlass-kernels-via-jax-shard-map "Link to this heading")
...
### How sharding works[\#](#how-sharding-works "Link to this heading")
...
## Exporting CUTLASS kernels with `jax.export`[\#](#exporting-cutlass-kernels-with-jax-export "Link to this heading")
...
### What `jax.export` gives you[\#](#what-jax-export-gives-you "Link to this heading")
...
### Exporting with symbolic shapes[\#](#exporting-with-symbolic-shapes "Link to this heading")
...
[](../ffi.html "previous page")

previous

Foreign function interface (FFI)

[](../gradient-checkpointing.html "next page")
