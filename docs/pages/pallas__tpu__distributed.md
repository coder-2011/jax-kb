...
- [ .ipynb](../../_sources/pallas/tpu/distributed.ipynb "Download source file")
-  .pdf
...
- [TPU Topologies](#tpu-topologies)
- [Remote Direct Memory Access (RDMA) Model](#remote-direct-memory-access-rdma-model)
  - [Async Remote Copy Operation](#async-remote-copy-operation)
  - [DMA Semaphores](#dma-semaphores)
  - [Routing](#routing)
  - [Failure modes](#failure-modes)
  - [Example: Right Permute (`lax.ppermute`)](#example-right-permute-lax-ppermute)
  - [Example: All-gather (`lax.all_gather`)](#example-all-gather-lax-all-gather)
    - [Ring Communication Pattern](#ring-communication-pattern)
- [Advanced Techniques](#advanced-techniques)
  - [Synchronization: Regular and Barrier Semaphores](#synchronization-regular-and-barrier-semaphores)
    - [Regular Semaphores](#regular-semaphores)
    - [Barrier Semaphores](#barrier-semaphores)
  - [Double-buffering](#double-buffering)
  - [Example: All-Reduce Sum (`lax.psum`)](#example-all-reduce-sum-lax-psum)
    - [Putting it all together](#putting-it-all-together)
  - [Run-ahead and Race Conditions](#run-ahead-and-race-conditions)
  - [Bi-directional Communication](#bi-directional-communication)
  - [Example: Bi-directional Reduce-Scatter (`lax.psum_scatter`)](#example-bi-directional-reduce-scatter-lax-psum-scatter)
  - [Nested Remote and Local DMA Pipelines](#nested-remote-and-local-dma-pipelines)
  - [Example: Reduce-Scatter with large HBM blocks](#example-reduce-scatter-with-large-hbm-blocks)
- [Final Notes](#final-notes)
  - [Megacore](#megacore)
  - [Interaction with XLA](#interaction-with-xla)
  - [Next Steps](#next-steps)

# Distributed Computing in Pallas for TPUs[\#](#distributed-computing-in-pallas-for-tpus "Link to this heading")
...
- [Pallas Pipelining on TPU](pipelining.html#pallas-tpu-pipelining)

- [Collectives with `jax.shard_map`](../../notebooks/shard_map.html#shard-map-collectives-tutorial)
...
## TPU Topologies[\#](#tpu-topologies "Link to this heading")
...
## Remote Direct Memory Access (RDMA) Model[\#](#remote-direct-memory-access-rdma-model "Link to this heading")
...
### Async Remote Copy Operation[\#](#async-remote-copy-operation "Link to this heading")
...
![rdma_start](../../_images/rdma_start.svg)
...
### DMA Semaphores[\#](#dma-semaphores "Link to this heading")
...
### Failure modes[\#](#failure-modes "Link to this heading")
...
### Example: Right Permute (`lax.ppermute`)[\#](#example-right-permute-lax-ppermute "Link to this heading")
...
### Example: All-gather (`lax.all_gather`)[\#](#example-all-gather-lax-all-gather "Link to this heading")
...
#### Ring Communication Pattern[\#](#ring-communication-pattern "Link to this heading")
...
## Advanced Techniques[\#](#advanced-techniques "Link to this heading")
...
### Synchronization: Regular and Barrier Semaphores[\#](#synchronization-regular-and-barrier-semaphores "Link to this heading")
...
#### Regular Semaphores[\#](#regular-semaphores "Link to this heading")
...
#### Barrier Semaphores[\#](#barrier-semaphores "Link to this heading")
...
### Double-buffering[\#](#double-buffering "Link to this heading")
...
### Example: All-Reduce Sum (`lax.psum`)[\#](#example-all-reduce-sum-lax-psum "Link to this heading")
...
![reduce_sum_1](../../_images/reduce_sum_1.svg)
...
![reduce_sum_2](../../_images/reduce_sum_2.svg)
...
### Run-ahead and Race Conditions[\#](#run-ahead-and-race-conditions "Link to this heading")
...
![race_condition](../../_images/race_condition.svg)
...
### Bi-directional Communication[\#](#bi-directional-communication "Link to this heading")
...
### Example: Bi-directional Reduce-Scatter (`lax.psum_scatter`)[\#](#example-bi-directional-reduce-scatter-lax-psum-scatter "Link to this heading")
...
![reduce_scatter_1](../../_images/reduce_scatter_1.svg)
...
![reduce_scatter_2](../../_images/reduce_scatter_2.svg)
...
### Nested Remote and Local DMA Pipelines[\#](#nested-remote-and-local-dma-pipelines "Link to this heading")
...
### Example: Reduce-Scatter with large HBM blocks[\#](#example-reduce-scatter-with-large-hbm-blocks "Link to this heading")
...
[](sparse.html "previous page")

previous

Scalar Prefetch and Block-Sparse Computation

[](core_map.html "next page")
