...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.poisson.logpmf.rst "Download source file")
-  .pdf
...
- [`logpmf()`](#jax.scipy.stats.poisson.logpmf)

# jax.scipy.stats.poisson.logpmf[\#](#jax-scipy-stats-poisson-logpmf "Link to this heading")

jax.scipy.stats.poisson.logpmf(*k*, *mu*, *loc=0*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/poisson.py#L26-L58)[\#](#jax.scipy.stats.poisson.logpmf "Link to this definition")  
Poisson log probability mass function.

JAX implementation of [`scipy.stats.poisson`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.poisson.html#scipy.stats.poisson "(in SciPy v1.19.0.dev)") `logpmf`.
...
[](jax.scipy.stats.pareto.sf.html "previous page")

previous

jax.scipy.stats.pareto.sf

[](jax.scipy.stats.poisson.pmf.html "next page")
