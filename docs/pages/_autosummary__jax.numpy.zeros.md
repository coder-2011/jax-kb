...
- [ .rst](../_sources/_autosummary/jax.numpy.zeros.rst "Download source file")
-  .pdf
...
# jax.numpy.zeros[\#](#jax-numpy-zeros "Link to this heading")

jax.numpy.zeros(*shape*, *dtype=None*, *\**, *device=None*, *out_sharding=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/numpy/array_creation.py#L49-L96)[\#](#jax.numpy.zeros "Link to this definition")  
Create an array full of zeros.

JAX implementation of [`numpy.zeros()`](https://numpy.org/doc/stable/reference/generated/numpy.zeros.html#numpy.zeros "(in NumPy v2.4)").
...
[](jax.numpy.where.html "previous page")

previous

jax.numpy.where

[](jax.numpy.zeros_like.html "next page")
