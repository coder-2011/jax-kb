...
- [ .rst](_sources/transfer_guard.rst "Download source file")
-  .pdf

# Transfer guard

# Transfer guard[\#](#transfer-guard "Link to this heading")
...
[](debugging/xla_metadata.html "previous page")

previous

Attaching XLA Metadata with `set_xla_metadata`

[](custom_pytrees.html "next page")
