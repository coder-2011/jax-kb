...
- [ .md](../_sources/debugging/index.md "Download source file")
-  .pdf
...
- [Interactive inspection with `jax.debug`](#interactive-inspection-with-jax-debug)
...
- [Attaching XLA Metadata with `set_xla_metadata`](#attaching-xla-metadata-with-set-xla-metadata)

# Debugging runtime values[\#](#debugging-runtime-values "Link to this heading")
...
- [Interactive inspection with `jax.debug`](print_breakpoint.html)

- [Functional error checks with jax.experimental.checkify](checkify_guide.html)

- [Throwing Python errors with JAX’s debug flags](flags.html)

- [Attaching XLA metadata with `set_xla_metadata`](xla_metadata.html)

## Interactive inspection with `jax.debug`[\#](#interactive-inspection-with-jax-debug "Link to this heading")

Complete guide [here](print_breakpoint.html)

**Summary:** Use [`jax.debug.print()`](../_autosummary/jax.debug.print.html#jax.debug.print "jax.debug.print") to print values to stdout in `jax.jit`-,`jax.pmap`-, and `pjit`-decorated functions, and [`jax.debug.breakpoint()`](../_autosummary/jax.debug.breakpoint.html#jax.debug.breakpoint "jax.debug.breakpoint") to pause execution of your compiled function to inspect values in the call stack:
...
[Read more](print_breakpoint.html).
...
Complete guide [here](checkify_guide.html)
...
[Read more](xla_metadata.html).

Read more

- [JAX debugging flags](flags.html)
- [Compiled prints and breakpoints](print_breakpoint.html)
- [The `checkify` transformation](checkify_guide.html)
- [Attaching XLA Metadata with `set_xla_metadata`](xla_metadata.html)
- [What is XLA Metadata?](xla_metadata.html#what-is-xla-metadata)
- [Usage](xla_metadata.html#usage)
- [Interaction with JAX Transformations](xla_metadata.html#interaction-with-jax-transformations)

[](../debugging.html "previous page")

previous

Introduction to debugging

[](flags.html "next page")
