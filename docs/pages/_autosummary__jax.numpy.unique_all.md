...
- [ .rst](../_sources/_autosummary/jax.numpy.unique_all.rst "Download source file")
-  .pdf
...
- [`unique_all()`](#jax.numpy.unique_all)

# jax.numpy.unique_all[\#](#jax-numpy-unique-all "Link to this heading")

jax.numpy.unique_all(*x*, */*, *\**, *size=None*, *fill_value=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/numpy/setops.py#L884-L965)[\#](#jax.numpy.unique_all "Link to this definition")  
Return unique values from x, along with indices, inverse indices, and counts.

JAX implementation of [`numpy.unique_all()`](https://numpy.org/doc/stable/reference/generated/numpy.unique_all.html#numpy.unique_all "(in NumPy v2.4)"); this is equivalent to calling [`jax.numpy.unique()`](jax.numpy.unique.html#jax.numpy.unique "jax.numpy.unique") with return_index, return_inverse, return_counts, and equal_nan set to True.

Because the size of the output of `unique_all` is data-dependent, the function is not typically compatible with [`jit()`](jax.jit.html#jax.jit "jax.jit") and other JAX transformations. The JAX version adds the optional `size` argument which must be specified statically for `jnp.unique` to be used in such contexts.
...
The result is a [`NamedTuple`](https://docs.python.org/3/library/typing.html#typing.NamedTuple "(in Python v3.14)") with four named attributes. The `values` attribute contains the unique values from the array:
...
[](jax.numpy.unique.html "previous page")

previous

jax.numpy.unique

[](jax.numpy.unique_counts.html "next page")
