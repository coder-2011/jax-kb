...
- [ .md](_sources/deprecation.md "Download source file")
-  .pdf

# Python and NumPy version support policy

# Python and NumPy version support policy[\#](#python-and-numpy-version-support-policy "Link to this heading")

For NumPy and SciPy version support, JAX follows the Python scientific community’s [SPEC 0](https://scientific-python.org/specs/spec-0000/).
...
[](api_compatibility.html "previous page")

previous

API compatibility

[](async_dispatch.html "next page")
