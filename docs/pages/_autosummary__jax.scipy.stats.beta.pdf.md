...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.beta.pdf.rst "Download source file")
-  .pdf
...
- [`pdf()`](#jax.scipy.stats.beta.pdf)

# jax.scipy.stats.beta.pdf[\#](#jax-scipy-stats-beta-pdf "Link to this heading")

jax.scipy.stats.beta.pdf(*x*, *a*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/beta.py#L72-L105)[\#](#jax.scipy.stats.beta.pdf "Link to this definition")  
Beta probability distribution function.

JAX implementation of [`scipy.stats.beta`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.beta.html#scipy.stats.beta "(in SciPy v1.19.0.dev)") `pdf`.
...
[](jax.scipy.stats.beta.logpdf.html "previous page")

previous

jax.scipy.stats.beta.logpdf

[](jax.scipy.stats.beta.cdf.html "next page")
