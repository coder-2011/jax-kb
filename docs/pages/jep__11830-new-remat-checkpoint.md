...
- [ .md](../_sources/jep/11830-new-remat-checkpoint.md "Download source file")
-  .pdf
...
# `jax.remat` / `jax.checkpoint` changes: what you need to know[\#](#jax-remat-jax-checkpoint-changes-what-you-need-to-know "Link to this heading")

This document discusses changes made to `jax.checkpoint` (a.k.a. `jax.remat`) that were finalized in JAX v0.3.17, released in August 2022.
...
As of `jax==0.3.17` the `jax_new_checkpoint` config option is no longer available. If you have an issue, please reach out on [the issue tracker](https://github.com/jax-ml/jax/issues) so we can help fix it!

## Why are we doing this?[\#](#why-are-we-doing-this "Link to this heading")
...
### User-customizable rematerialization policies[\#](#user-customizable-rematerialization-policies "Link to this heading")
...
### Ability to rematerialize constants, not just operations with data dependence on arguments[\#](#ability-to-rematerialize-constants-not-just-operations-with-data-dependence-on-arguments "Link to this heading")
...
### Significantly less Python overhead in some cases[\#](#significantly-less-python-overhead-in-some-cases "Link to this heading")
...
### Enabling new JAX features by simplifying internals[\#](#enabling-new-jax-features-by-simplifying-internals "Link to this heading")
...
## What are the possible issues after the upgrade?[\#](#what-are-the-possible-issues-after-the-upgrade "Link to this heading")

### Innocuous numerical changes[\#](#innocuous-numerical-changes "Link to this heading")
...
### The `concrete=True` option is removed.[\#](#the-concrete-true-option-is-removed "Link to this heading")
...
[](10657-sequencing-effects.html "previous page")

previous

Sequencing side-effects in JAX

[](12049-type-annotations.html "next page")
