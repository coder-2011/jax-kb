...
- [ .rst](../_sources/_autosummary/jax.lax.scatter_min.rst "Download source file")
-  .pdf
...
# jax.lax.scatter_min[\#](#jax-lax-scatter-min "Link to this heading")

jax.lax.scatter_min(*operand*, *scatter_indices*, *updates*, *dimension_numbers*, *\**, *indices_are_sorted=False*, *unique_indices=False*, *mode=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/lax/slicing.py#L673-L722)[\#](#jax.lax.scatter_min "Link to this definition")  
Scatter-min operator.

Wraps [XLA’s Scatter operator](https://www.openxla.org/xla/operation_semantics#scatter), where the min function is used to combine updates and values from operand.
...
[](jax.lax.scatter_max.html "previous page")

previous

jax.lax.scatter_max

[](jax.lax.scatter_mul.html "next page")
