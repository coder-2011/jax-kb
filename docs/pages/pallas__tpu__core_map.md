...
- [ .ipynb](../../_sources/pallas/tpu/core_map.ipynb "Download source file")
-  .pdf
...
- [A simple per-core kernel](#a-simple-per-core-kernel)
  - [Save the boilerplate](#save-the-boilerplate)
- [Pipelining with `core_map`](#pipelining-with-core-map)
- [Scalar prefetch](#scalar-prefetch)
- [Mapping over SparseCores](#mapping-over-sparsecores)

# Pallas Core-specific Programming[\#](#pallas-core-specific-programming "Link to this heading")
...
## A simple per-core kernel[\#](#a-simple-per-core-kernel "Link to this heading")
...
### Save the boilerplate[\#](#save-the-boilerplate "Link to this heading")
...
## Pipelining with `core_map`[\#](#pipelining-with-core-map "Link to this heading")
...
## Scalar prefetch[\#](#scalar-prefetch "Link to this heading")
...
## Mapping over SparseCores[\#](#mapping-over-sparsecores "Link to this heading")
