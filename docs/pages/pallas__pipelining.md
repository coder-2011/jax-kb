...
- [ .ipynb](../_sources/pallas/pipelining.ipynb "Download source file")
-  .pdf
...
- [Pipelining Basics](#pipelining-basics)
  - [Deriving a Double-Buffered Pipeline](#deriving-a-double-buffered-pipeline)
- [Pallas Pipelining API](#pallas-pipelining-api)
  - [Grid](#grid)
  - [BlockSpecs](#blockspecs)
  - [Kernel](#kernel)
  - [Pallas Call](#pallas-call)
  - [Example - Elementwise Kernel revisited](#example-elementwise-kernel-revisited)
  - [Parameterizing a Kernel](#parameterizing-a-kernel)
- [Sharp edges](#sharp-edges)
  - [Buffer Revisiting](#buffer-revisiting)
  - [Reductions and accumulation](#reductions-and-accumulation)
- [Analyzing the performance](#analyzing-the-performance)

# Software Pipelining[\#](#software-pipelining "Link to this heading")
...
This tutorial only covers the conceptual foundations of pipelining. For platform-specific references, please see [TPU Pipelining](tpu/pipelining.html#pallas-tpu-pipelining), or [Mosaic GPU Pipelining](gpu/pipelining.html#pallas-mgpu-pipelining).
...
## Memory Hierarchies[\#](#memory-hierarchies "Link to this heading")
...
![memory_hierarchy](../_images/pipelining_mem_hierarchy.svg)
...
## Pipelining Basics[\#](#pipelining-basics "Link to this heading")
...
![pipelining_example](../_images/pipelining_example.svg)
...
### Deriving a Double-Buffered Pipeline[\#](#deriving-a-double-buffered-pipeline "Link to this heading")
...
### BlockSpecs[\#](#blockspecs "Link to this heading")
...
### Pallas Call[\#](#pallas-call "Link to this heading")
...
### Example - Elementwise Kernel revisited[\#](#example-elementwise-kernel-revisited "Link to this heading")
...
### Parameterizing a Kernel[\#](#parameterizing-a-kernel "Link to this heading")
...
## Sharp edges[\#](#sharp-edges "Link to this heading")
...
### Buffer Revisiting[\#](#buffer-revisiting "Link to this heading")
...
### Reductions and accumulation[\#](#reductions-and-accumulation "Link to this heading")
...
## Analyzing the performance[\#](#analyzing-the-performance "Link to this heading")
...
![pipelining_compute](../_images/pipelining_compute_bound.svg)
...
![pipelining_bandwidth](../_images/pipelining_bandwidth_bound.svg)
...
![pipelining_latency](../_images/pipelining_latency_multistage.svg)
