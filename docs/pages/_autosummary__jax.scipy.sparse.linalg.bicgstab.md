...
- [ .rst](../_sources/_autosummary/jax.scipy.sparse.linalg.bicgstab.rst "Download source file")
-  .pdf
...
# jax.scipy.sparse.linalg.bicgstab[\#](#jax-scipy-sparse-linalg-bicgstab "Link to this heading")

jax.scipy.sparse.linalg.bicgstab(*A*, *b*, *x0=None*, *\**, *tol=1e-05*, *atol=0.0*, *maxiter=None*, *M=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/sparse/linalg.py#L704-L762)[\#](#jax.scipy.sparse.linalg.bicgstab "Link to this definition")  
...
[`scipy.sparse.linalg.bicgstab`](https://scipy.github.io/devdocs/reference/generated/scipy.sparse.linalg.bicgstab.html#scipy.sparse.linalg.bicgstab "(in SciPy v1.19.0.dev)"), [`jax.lax.custom_linear_solve`](jax.lax.custom_linear_solve.html#jax.lax.custom_linear_solve "jax.lax.custom_linear_solve")

[](jax.scipy.spatial.transform.Slerp.html "previous page")

previous

jax.scipy.spatial.transform.Slerp

[](jax.scipy.sparse.linalg.cg.html "next page")
