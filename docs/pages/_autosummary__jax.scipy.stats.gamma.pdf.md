...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gamma.pdf.rst "Download source file")
-  .pdf
...
# jax.scipy.stats.gamma.pdf[\#](#jax-scipy-stats-gamma-pdf "Link to this heading")

jax.scipy.stats.gamma.pdf(*x*, *a*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gamma.py#L65-L96)[\#](#jax.scipy.stats.gamma.pdf "Link to this definition")  
Gamma probability distribution function.

JAX implementation of [`scipy.stats.gamma`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.gamma.html#scipy.stats.gamma "(in SciPy v1.19.0.dev)") `pdf`.
...
[](jax.scipy.stats.gamma.logpdf.html "previous page")

previous

jax.scipy.stats.gamma.logpdf

[](jax.scipy.stats.gamma.cdf.html "next page")
