...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.pareto.logcdf.rst "Download source file")
-  .pdf
...
- [`logcdf()`](#jax.scipy.stats.pareto.logcdf)

# jax.scipy.stats.pareto.logcdf[\#](#jax-scipy-stats-pareto-logcdf "Link to this heading")

jax.scipy.stats.pareto.logcdf(*x*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/pareto.py#L151-L190)[\#](#jax.scipy.stats.pareto.logcdf "Link to this definition")  
Pareto log cumulative distribution function.

JAX implementation of [`scipy.stats.pareto`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.pareto.html#scipy.stats.pareto "(in SciPy v1.19.0.dev)") `logcdf`.
...
[](jax.scipy.stats.norm.isf.html "previous page")

previous

jax.scipy.stats.norm.isf

[](jax.scipy.stats.pareto.logpdf.html "next page")
