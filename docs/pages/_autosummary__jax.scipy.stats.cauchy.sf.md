...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.cauchy.sf.rst "Download source file")
-  .pdf
...
- [`sf()`](#jax.scipy.stats.cauchy.sf)

# jax.scipy.stats.cauchy.sf[\#](#jax-scipy-stats-cauchy-sf "Link to this heading")

jax.scipy.stats.cauchy.sf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/cauchy.py#L162-L195)[\#](#jax.scipy.stats.cauchy.sf "Link to this definition")  
Cauchy distribution log survival function.

JAX implementation of [`scipy.stats.cauchy`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.cauchy.html#scipy.stats.cauchy "(in SciPy v1.19.0.dev)") `sf`.
...
[](jax.scipy.stats.cauchy.logcdf.html "previous page")

previous

jax.scipy.stats.cauchy.logcdf

[](jax.scipy.stats.cauchy.logsf.html "next page")
