...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.norm.isf.rst "Download source file")
-  .pdf
...
- [`isf()`](#jax.scipy.stats.norm.isf)

# jax.scipy.stats.norm.isf[\#](#jax-scipy-stats-norm-isf "Link to this heading")

jax.scipy.stats.norm.isf(*q*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/norm.py#L259-L285)[\#](#jax.scipy.stats.norm.isf "Link to this definition")  
Normal distribution inverse survival function.

JAX implementation of [`scipy.stats.norm`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.norm.html#scipy.stats.norm "(in SciPy v1.19.0.dev)") `isf`.

Returns the inverse of the survival function, [`jax.scipy.stats.norm.sf()`](jax.scipy.stats.norm.sf.html#jax.scipy.stats.norm.sf "jax.scipy.stats.norm.sf").
...
[](jax.scipy.stats.norm.logsf.html "previous page")

previous

jax.scipy.stats.norm.logsf

[](jax.scipy.stats.pareto.logcdf.html "next page")
