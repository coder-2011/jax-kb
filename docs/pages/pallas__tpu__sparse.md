...
- [ .ipynb](../../_sources/pallas/tpu/sparse.ipynb "Download source file")
-  .pdf
...
- [Dynamic Block Indexing with Scalar Prefetch](#dynamic-block-indexing-with-scalar-prefetch)
- [Example: Block Dynamic Slice with Scalar Prefetch](#example-block-dynamic-slice-with-scalar-prefetch)
- [Sparse Kernels: Representing Sparse Data](#sparse-kernels-representing-sparse-data)
- [Example: Sparse @ Dense Matrix Multiplication](#example-sparse-dense-matrix-multiplication)
- [Sparse Access Patterns on Dense Data](#sparse-access-patterns-on-dense-data)
- [Example: Dense @ Dense Matrix Multiplication with a Block-Sparse Output Mask](#example-dense-dense-matrix-multiplication-with-a-block-sparse-output-mask)

# Scalar Prefetch and Block-Sparse Computation[\#](#scalar-prefetch-and-block-sparse-computation "Link to this heading")
...
## Dynamic Block Indexing with Scalar Prefetch[\#](#dynamic-block-indexing-with-scalar-prefetch "Link to this heading")
...
## Example: Block Dynamic Slice with Scalar Prefetch[\#](#example-block-dynamic-slice-with-scalar-prefetch "Link to this heading")
...
## Sparse Kernels: Representing Sparse Data[\#](#sparse-kernels-representing-sparse-data "Link to this heading")
...
![block_coo](../../_images/block_coo.svg)
...
## Example: Sparse @ Dense Matrix Multiplication[\#](#example-sparse-dense-matrix-multiplication "Link to this heading")
...
![sparse_matmul](../../_images/sparse_matmul.svg)
...
## Sparse Access Patterns on Dense Data[\#](#sparse-access-patterns-on-dense-data "Link to this heading")
...
![prefetch_map](../../_images/prefetch_map.svg)
...
## Example: Dense @ Dense Matrix Multiplication with a Block-Sparse Output Mask[\#](#example-dense-dense-matrix-multiplication-with-a-block-sparse-output-mask "Link to this heading")
