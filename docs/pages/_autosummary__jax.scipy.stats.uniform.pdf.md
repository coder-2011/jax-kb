...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.uniform.pdf.rst "Download source file")
-  .pdf
...
- [`pdf()`](#jax.scipy.stats.uniform.pdf)

# jax.scipy.stats.uniform.pdf[\#](#jax-scipy-stats-uniform-pdf "Link to this heading")

jax.scipy.stats.uniform.pdf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/uniform.py#L57-L85)[\#](#jax.scipy.stats.uniform.pdf "Link to this definition")  
Uniform probability distribution function.

JAX implementation of [`scipy.stats.uniform`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.uniform.html#scipy.stats.uniform "(in SciPy v1.19.0.dev)") `pdf`.
...
[](jax.scipy.stats.uniform.logpdf.html "previous page")

previous

jax.scipy.stats.uniform.logpdf

[](jax.scipy.stats.uniform.cdf.html "next page")
