...
- [ .rst](../_sources/_autosummary/jax.numpy.dtype.rst "Download source file")
-  .pdf
...
- [`dtype`](#jax.numpy.dtype)
  - [`dtype.__init__()`](#jax.numpy.dtype.__init__)

# jax.numpy.dtype[\#](#jax-numpy-dtype "Link to this heading")

*class* jax.numpy.dtype(*dtype*, *align=False*, *copy=False*, *\*\*kwargs*)[\#](#jax.numpy.dtype "Link to this definition")  
–
...
- **align** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)")*,* *optional*) – Add padding to the fields to match what a C compiler would output for a similar C-struct. Can be `True` only if obj is a dictionary or a comma-separated string. If a struct dtype is being created, this also sets a sticky alignment flag `isalignedstruct`.

- **copy** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)")*,* *optional*) – Make a new copy of the data-type object. If `False`, the result may just be a reference to a built-in data-type object.

- **metadata** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")*,* *optional*) – An optional dictionary with dtype metadata.

See also

[`result_type`](jax.numpy.result_type.html#jax.numpy.result_type "jax.numpy.result_type")
...
\_\_init\_\_()[\#](#jax.numpy.dtype.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.numpy.dtype.__init__ "jax.numpy.dtype.__init__")() |  |
...
[](jax.numpy.dstack.html "previous page")

previous

jax.numpy.dstack

[](jax.numpy.ediff1d.html "next page")
