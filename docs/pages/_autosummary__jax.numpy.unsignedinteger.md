...
- [ .rst](../_sources/_autosummary/jax.numpy.unsignedinteger.rst "Download source file")
-  .pdf
...
- [`unsignedinteger`](#jax.numpy.unsignedinteger)
  - [`unsignedinteger.__init__()`](#jax.numpy.unsignedinteger.__init__)

# jax.numpy.unsignedinteger[\#](#jax-numpy-unsignedinteger "Link to this heading")

*class* jax.numpy.unsignedinteger[\#](#jax.numpy.unsignedinteger "Link to this definition")  
Abstract base class of all unsigned integer scalar types.

\_\_init\_\_()[\#](#jax.numpy.unsignedinteger.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.numpy.unsignedinteger.__init__ "jax.numpy.unsignedinteger.__init__")() |  |
...
| `is_integer`() | Return `True` if the number is finite with integral value. |
...
[](jax.numpy.unstack.html "previous page")

previous

jax.numpy.unstack

[](jax.numpy.unwrap.html "next page")
