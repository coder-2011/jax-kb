...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.beta.cdf.rst "Download source file")
-  .pdf
...
- [`cdf()`](#jax.scipy.stats.beta.cdf)

# jax.scipy.stats.beta.cdf[\#](#jax-scipy-stats-beta-cdf "Link to this heading")

jax.scipy.stats.beta.cdf(*x*, *a*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/beta.py#L107-L149)[\#](#jax.scipy.stats.beta.cdf "Link to this definition")  
Beta cumulative distribution function

JAX implementation of [`scipy.stats.beta`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.beta.html#scipy.stats.beta "(in SciPy v1.19.0.dev)") `cdf`.
...
[](jax.scipy.stats.beta.pdf.html "previous page")

previous

jax.scipy.stats.beta.pdf

[](jax.scipy.stats.beta.logcdf.html "next page")
