...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.logistic.pdf.rst "Download source file")
-  .pdf
...
- [`pdf()`](#jax.scipy.stats.logistic.pdf)

# jax.scipy.stats.logistic.pdf[\#](#jax-scipy-stats-logistic-pdf "Link to this heading")

jax.scipy.stats.logistic.pdf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/logistic.py#L58-L85)[\#](#jax.scipy.stats.logistic.pdf "Link to this definition")  
Logistic probability distribution function.

JAX implementation of [`scipy.stats.logistic`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.logistic.html#scipy.stats.logistic "(in SciPy v1.19.0.dev)") `pdf`.
...
[](jax.scipy.stats.logistic.logpdf.html "previous page")

previous

jax.scipy.stats.logistic.logpdf

[](jax.scipy.stats.logistic.ppf.html "next page")
