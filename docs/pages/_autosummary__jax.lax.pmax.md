...
- [ .rst](../_sources/_autosummary/jax.lax.pmax.rst "Download source file")
-  .pdf
...
# jax.lax.pmax[\#](#jax-lax-pmax "Link to this heading")

jax.lax.pmax(*x*, *axis_name*, *\**, *axis_index_groups=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/lax/parallel.py#L229-L258)[\#](#jax.lax.pmax "Link to this definition")  
...
[](jax.lax.psum_scatter.html "previous page")

previous

jax.lax.psum_scatter

[](jax.lax.pmin.html "next page")
