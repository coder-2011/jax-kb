...
- jax.scipy.stats.cauchy.logsf

[ ](https://github.com/jax-ml/jax "Source repository")

- [ .rst](../_sources/_autosummary/jax.scipy.stats.cauchy.logsf.rst "Download source file")
-  .pdf
...
- [`logsf()`](#jax.scipy.stats.cauchy.logsf)

# jax.scipy.stats.cauchy.logsf[\#](#jax-scipy-stats-cauchy-logsf "Link to this heading")

jax.scipy.stats.cauchy.logsf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/cauchy.py#L197-L230)[\#](#jax.scipy.stats.cauchy.logsf "Link to this definition")  
Cauchy distribution log survival function.

JAX implementation of [`scipy.stats.cauchy`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.cauchy.html#scipy.stats.cauchy "(in SciPy v1.19.0.dev)") `logsf`

The survival function is defined as

\\f\_{sf}(x) = 1 - f\_{cdf}(x)\\

where \\f\_{cdf}(x)\\ is the cumulative distribution function, [`jax.scipy.stats.cauchy.cdf()`](jax.scipy.stats.cauchy.cdf.html#jax.scipy.stats.cauchy.cdf "jax.scipy.stats.cauchy.cdf").
...
[](jax.scipy.stats.cauchy.sf.html "previous page")

previous

jax.scipy.stats.cauchy.sf

[](jax.scipy.stats.cauchy.isf.html "next page")
