...
- [ .rst](../_sources/_autosummary/jax.lax.scatter_max.rst "Download source file")
-  .pdf
...
# jax.lax.scatter_max[\#](#jax-lax-scatter-max "Link to this heading")

jax.lax.scatter_max(*operand*, *scatter_indices*, *updates*, *dimension_numbers*, *\**, *indices_are_sorted=False*, *unique_indices=False*, *mode=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/lax/slicing.py#L723-L772)[\#](#jax.lax.scatter_max "Link to this definition")  
Scatter-max operator.

Wraps [XLA’s Scatter operator](https://www.openxla.org/xla/operation_semantics#scatter), where the max function is used to combine updates and values from operand.
...
[](jax.lax.scatter_apply.html "previous page")

previous

jax.lax.scatter_apply

[](jax.lax.scatter_min.html "next page")
