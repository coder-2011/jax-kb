...
- [ .ipynb](../../_sources/pallas/gpu/pipelining.ipynb "Download source file")
-  .pdf
...
- [Pipelining with Mosaic GPU](#pipelining-with-mosaic-gpu)
  - [Compatibility API using `pl.pallas_call`](#compatibility-api-using-pl-pallas-call)
- [GPU Memory Spaces](#gpu-memory-spaces)
- [Example: Matmul Kernel on Hopper GPUs](#example-matmul-kernel-on-hopper-gpus)
- [Warp Specialization](#warp-specialization)
- [Example: Matrix Multiplication with Warp Specialization](#example-matrix-multiplication-with-warp-specialization)

# Mosaic GPU Pipelining[\#](#mosaic-gpu-pipelining "Link to this heading")

This guide covers software pipelining using the Mosaic GPU backend for Pallas.

For a general overview of the pipelining API in Pallas, we recommend that users first read [Software Pipelining](../pipelining.html#pallas-software-pipelining). Pipelining in Pallas is programmed explicitly. For those who are familiar with Triton, this is a significant difference in programming model because in Triton, pipelining is an optimization that is done automatically by the compiler.
...
## Pipelining with Mosaic GPU[\#](#pipelining-with-mosaic-gpu "Link to this heading")
...
### Compatibility API using `pl.pallas_call`[\#](#compatibility-api-using-pl-pallas-call "Link to this heading")
...
## GPU Memory Spaces[\#](#gpu-memory-spaces "Link to this heading")
...
## Example: Matmul Kernel on Hopper GPUs[\#](#example-matmul-kernel-on-hopper-gpus "Link to this heading")
...
![](../../_static/pallas/gpu/pipeline_matmul.svg)
...
## Warp Specialization[\#](#warp-specialization "Link to this heading")
...
![](../../_static/pallas/gpu/warp_specialization.svg)
...
## Example: Matrix Multiplication with Warp Specialization[\#](#example-matrix-multiplication-with-warp-specialization "Link to this heading")
...
![](../../_static/pallas/gpu/pipeline_matmul_ws.svg)
...
[](reference.html "previous page")

previous

Writing Mosaic GPU kernels with Pallas

[](blackwell_matmul.html "next page")
