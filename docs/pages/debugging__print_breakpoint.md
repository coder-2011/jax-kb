...
- [ .md](../_sources/debugging/print_breakpoint.md "Download source file")
-  .pdf
...
- [Debugging with `jax.debug.print` and other debugging callbacks](#debugging-with-jax-debug-print-and-other-debugging-callbacks)
  ...
  - [Sharp bits](#sharp-bits)
    ...
    - [Computation perturbation](#computation-perturbation)
...
# Compiled prints and breakpoints[\#](#compiled-prints-and-breakpoints "Link to this heading")

The [`jax.debug`](../jax.debug.html#module-jax.debug "jax.debug") package offers some useful tools for inspecting values inside of compiled functions.

## Debugging with `jax.debug.print` and other debugging callbacks[\#](#debugging-with-jax-debug-print-and-other-debugging-callbacks "Link to this heading")

**Summary:** Use [`jax.debug.print()`](../_autosummary/jax.debug.print.html#jax.debug.print "jax.debug.print") to print traced array values to stdout in compiled (e.g. `jax.jit` or `jax.pmap`-decorated) functions:
...
except that it can be staged out and transformed by JAX. See the [`API`` ``reference`](../_autosummary/jax.debug.print.html#jax.debug.print "jax.debug.print") for more details.
...
### When to use “*debug*” print?[\#](#when-to-use-debug-print "Link to this heading")
...
### Why “*debug*” print?[\#](#why-debug-print "Link to this heading")
...
### More examples of `jax.debug.print`[\#](#more-examples-of-jax-debug-print "Link to this heading")

In addition to the above examples using `jit` and `vmap`, here are a few more to have in mind.

#### Printing under `jax.pmap`[\#](#printing-under-jax-pmap "Link to this heading")
...
#### Printing under `jax.grad`[\#](#printing-under-jax-grad "Link to this heading")
...
#### Printing in other transformations[\#](#printing-in-other-transformations "Link to this heading")

`jax.debug.print` also works in other transformations like `pjit`.

### More control with `jax.debug.callback`[\#](#more-control-with-jax-debug-callback "Link to this heading")
...
### Sharp bits[\#](#sharp-bits "Link to this heading")

Like most JAX APIs, `jax.debug.print` can cut you if you’re not careful.

#### Ordering of printed results[\#](#ordering-of-printed-results "Link to this heading")
...
#### Computation perturbation[\#](#computation-perturbation "Link to this heading")
...
#### Asynchronous callbacks[\#](#asynchronous-callbacks "Link to this heading")
...
#### Performance impacts[\#](#performance-impacts "Link to this heading")

##### Unnecessary materialization[\#](#unnecessary-materialization "Link to this heading")
...
##### Callback overhead[\#](#callback-overhead "Link to this heading")
...
### Strengths and limitations of `jax.debug.print`[\#](#strengths-and-limitations-of-jax-debug-print "Link to this heading")
...
## Interactive inspection with `jax.debug.breakpoint()`[\#](#interactive-inspection-with-jax-debug-breakpoint "Link to this heading")
...
#### Usage with `jax.lax.cond`[\#](#usage-with-jax-lax-cond "Link to this heading")
...
### Sharp bits[\#](#id1 "Link to this heading")
...
### Strengths and limitations of `jax.debug.breakpoint()`[\#](#strengths-and-limitations-of-jax-debug-breakpoint "Link to this heading")
...
[](flags.html "previous page")

previous

JAX debugging flags

[](checkify_guide.html "next page")
