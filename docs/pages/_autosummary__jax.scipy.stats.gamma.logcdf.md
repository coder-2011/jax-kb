...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gamma.logcdf.rst "Download source file")
-  .pdf
...
- [`logcdf()`](#jax.scipy.stats.gamma.logcdf)

# jax.scipy.stats.gamma.logcdf[\#](#jax-scipy-stats-gamma-logcdf "Link to this heading")

jax.scipy.stats.gamma.logcdf(*x*, *a*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gamma.py#L139-L170)[\#](#jax.scipy.stats.gamma.logcdf "Link to this definition")  
Gamma log cumulative distribution function.

JAX implementation of [`scipy.stats.gamma`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.gamma.html#scipy.stats.gamma "(in SciPy v1.19.0.dev)") `logcdf`.
...
[](jax.scipy.stats.gamma.cdf.html "previous page")

previous

jax.scipy.stats.gamma.cdf

[](jax.scipy.stats.gamma.sf.html "next page")
