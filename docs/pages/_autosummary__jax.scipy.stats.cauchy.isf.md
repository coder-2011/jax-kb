...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.cauchy.isf.rst "Download source file")
-  .pdf
...
- [`isf()`](#jax.scipy.stats.cauchy.isf)

# jax.scipy.stats.cauchy.isf[\#](#jax-scipy-stats-cauchy-isf "Link to this heading")

jax.scipy.stats.cauchy.isf(*q*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/cauchy.py#L232-L262)[\#](#jax.scipy.stats.cauchy.isf "Link to this definition")  
Cauchy distribution inverse survival function.

JAX implementation of [`scipy.stats.cauchy`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.cauchy.html#scipy.stats.cauchy "(in SciPy v1.19.0.dev)") `isf`.

Returns the inverse of the survival function, [`jax.scipy.stats.cauchy.sf()`](jax.scipy.stats.cauchy.sf.html#jax.scipy.stats.cauchy.sf "jax.scipy.stats.cauchy.sf").
...
[](jax.scipy.stats.cauchy.logsf.html "previous page")

previous

jax.scipy.stats.cauchy.logsf

[](jax.scipy.stats.cauchy.ppf.html "next page")
