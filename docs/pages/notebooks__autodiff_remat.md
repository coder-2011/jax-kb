...
- [ .ipynb](../_sources/notebooks/autodiff_remat.ipynb "Download source file")
-  .pdf
...
# Control autodiff’s saved values with `jax.checkpoint` (aka `jax.remat`)[\#](#control-autodiff-s-saved-values-with-jax-checkpoint-aka-jax-remat "Link to this heading")
...
### Fundamentals of `jax.checkpoint`[\#](#fundamentals-of-jax-checkpoint "Link to this heading")
...
[](autodiff_cookbook.html "previous page")

previous

The Autodiff Cookbook

[](../advanced_autodiff.html "next page")
