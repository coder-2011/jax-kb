...
- [ .rst](../_sources/_autosummary/jax.nn.initializers.kaiming_normal.rst "Download source file")
-  .pdf
...
# jax.nn.initializers.kaiming_normal[\#](#jax-nn-initializers-kaiming-normal "Link to this heading")

jax.nn.initializers.kaiming_normal(*in_axis=-2*, *out_axis=-1*, *batch_axis=()*, *dtype=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/nn/initializers.py#L560-L595)[\#](#jax.nn.initializers.kaiming_normal "Link to this definition")  
...
[](jax.nn.initializers.he_uniform.html "previous page")

previous

jax.nn.initializers.he_uniform

[](jax.nn.initializers.kaiming_uniform.html "next page")
