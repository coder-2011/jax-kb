...
- [ .rst](../_sources/_autosummary/jax.random.chisquare.rst "Download source file")
-  .pdf
...
# jax.random.chisquare[\#](#jax-random-chisquare "Link to this heading")

jax.random.chisquare(*key*, *df*, *shape=None*, *dtype=None*, *\**, *out_sharding=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/random/core.py#L2314-L2362)[\#](#jax.random.chisquare "Link to this definition")  
...
[](jax.random.cauchy.html "previous page")

previous

jax.random.cauchy

[](jax.random.choice.html "next page")
