...
- [ .rst](../_sources/_autosummary/jax.numpy.integer.rst "Download source file")
-  .pdf
...
- [`integer`](#jax.numpy.integer)
  - [`integer.__init__()`](#jax.numpy.integer.__init__)

# jax.numpy.integer[\#](#jax-numpy-integer "Link to this heading")

*class* jax.numpy.integer[\#](#jax.numpy.integer "Link to this definition")  
Abstract base class of all integer scalar types.

\_\_init\_\_()[\#](#jax.numpy.integer.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.numpy.integer.__init__ "jax.numpy.integer.__init__")() |  |
...
[](jax.numpy.int8.html "previous page")

previous

jax.numpy.int8

[](jax.numpy.interp.html "next page")
