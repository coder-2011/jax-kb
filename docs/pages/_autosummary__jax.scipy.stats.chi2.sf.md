...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.chi2.sf.rst "Download source file")
-  .pdf
...
- [`sf()`](#jax.scipy.stats.chi2.sf)

# jax.scipy.stats.chi2.sf[\#](#jax-scipy-stats-chi2-sf "Link to this heading")

jax.scipy.stats.chi2.sf(*x*, *df*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/chi2.py#L190-L234)[\#](#jax.scipy.stats.chi2.sf "Link to this definition")  
Chi-square survival function.

JAX implementation of [`scipy.stats.chi2`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.chi2.html#scipy.stats.chi2 "(in SciPy v1.19.0.dev)") `sf`.
...
[](jax.scipy.stats.chi2.logcdf.html "previous page")

previous

jax.scipy.stats.chi2.logcdf

[](jax.scipy.stats.chi2.logsf.html "next page")
