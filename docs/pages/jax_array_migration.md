...
- [ .md](_sources/jax_array_migration.md "Download source file")
-  .pdf
...
# jax.Array migration[\#](#jax-array-migration "Link to this heading")
...
### How to enable jax.Array?[\#](#how-to-enable-jax-array "Link to this heading")
...
### How do I know if jax.Array broke my code?[\#](#how-do-i-know-if-jax-array-broke-my-code "Link to this heading")
...
### How can I disable jax.Array for now?[\#](#how-can-i-disable-jax-array-for-now "Link to this heading")
...
## Why create jax.Array?[\#](#why-create-jax-array "Link to this heading")
...
## What issues can arise when jax.Array is switched on?[\#](#what-issues-can-arise-when-jax-array-is-switched-on "Link to this heading")

### New public type named jax.Array[\#](#new-public-type-named-jax-array "Link to this heading")
...
### GDA’s API name changes[\#](#gdas-api-name-changes "Link to this heading")
...
### Creating jax.Array[\#](#creating-jax-array "Link to this heading")

All JAX functions will output `jax.Array` when the `jax_array` flag is True. If you were using `GlobalDeviceArray.from_callback` or `make_sharded_device_array` or `make_device_array` functions to explicitly create the respective JAX data types, you will need to switch them to use [`jax.make_array_from_callback()`](_autosummary/jax.make_array_from_callback.html#jax.make_array_from_callback "jax.make_array_from_callback") or [`jax.make_array_from_single_device_arrays()`](_autosummary/jax.make_array_from_single_device_arrays.html#jax.make_array_from_single_device_arrays "jax.make_array_from_single_device_arrays").
...
### Breaking change for pjit after switching to jax.Array for host local inputs[\#](#breaking-change-for-pjit-after-switching-to-jax-array-for-host-local-inputs "Link to this heading")
...
### FROM_GDA and jax.Array[\#](#from-gda-and-jax-array "Link to this heading")
...
### live_buffers replaced with live_arrays[\#](#live-buffers-replaced-with-live-arrays "Link to this heading")
...
### Handling of host local inputs to pjit like batch, etc[\#](#handling-of-host-local-inputs-to-pjit-like-batch-etc "Link to this heading")
...
### RecursionError: Recursively calling jit[\#](#recursionerror-recursively-calling-jit "Link to this heading")
