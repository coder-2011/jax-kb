...
- [ .rst](../../_sources/pallas/tpu/details.rst "Download source file")
-  .pdf
...
# Writing TPU kernels with Pallas[\#](#writing-tpu-kernels-with-pallas "Link to this heading")
...
If you see unexpected outputs, please compare them against a kernel run with `interpret=True` passed in to `pallas_call`. If the results diverge, please file a [bug report](https://github.com/jax-ml/jax/issues/new/choose).

## What is a TPU?[\#](#what-is-a-tpu "Link to this heading")

[![A TPUv4 board](https://lh3.googleusercontent.com/PBWR5LFWaz8Nx4F7vRstDjt_nvUYdfxe9H3O9i3KMam_RmmwIOQMr1GAq3RUfowET2cK5kAcb_zGpw=e14-rw-lo-sc0xffffff-w2540)](https://lh3.googleusercontent.com/PBWR5LFWaz8Nx4F7vRstDjt_nvUYdfxe9H3O9i3KMam_RmmwIOQMr1GAq3RUfowET2cK5kAcb_zGpw=e14-rw-lo-sc0xffffff-w2540)
...
## Noteworthy properties and restrictions[\#](#noteworthy-properties-and-restrictions "Link to this heading")

### `BlockSpec`s and grid iteration[\#](#blockspecs-and-grid-iteration "Link to this heading")

`BlockSpec`s (see [BlockSpec, a.k.a. how to chunk up inputs](../grid_blockspec.html#pallas-blockspec)) generally behave as expected in Pallas — every invocation of the kernel body gets access to slices of the inputs and is meant to initialize a slice of the output.
...
What’s more, compared to GPUs, TPUs are actually highly sequential machines. Ergo, the grid is generally not processed in parallel, but sequentially, in lexicographic order (though see the [Multicore TPU configurations](#multicore-tpu-configurations) section for exceptions). This unlocks some interesting capabilities:
...
### Multicore TPU configurations[\#](#multicore-tpu-configurations "Link to this heading")
...
### Placing operands in SMEM[\#](#placing-operands-in-smem "Link to this heading")
...
### Computation placement[\#](#computation-placement "Link to this heading")
...
## Supported operations[\#](#supported-operations "Link to this heading")
...
#### Precision control[\#](#precision-control "Link to this heading")
...
### Accessing memory[\#](#accessing-memory "Link to this heading")
...
### Elementwise operations[\#](#elementwise-operations "Link to this heading")
...
### Array constructors[\#](#array-constructors "Link to this heading")
...
### Reshapes[\#](#reshapes "Link to this heading")
...
### Random Number Generation[\#](#random-number-generation "Link to this heading")
