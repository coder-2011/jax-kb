...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.nbinom.logpmf.rst "Download source file")
-  .pdf
...
- [`logpmf()`](#jax.scipy.stats.nbinom.logpmf)

# jax.scipy.stats.nbinom.logpmf[\#](#jax-scipy-stats-nbinom-logpmf "Link to this heading")

jax.scipy.stats.nbinom.logpmf(*k*, *n*, *p*, *loc=0*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/nbinom.py#L25-L59)[\#](#jax.scipy.stats.nbinom.logpmf "Link to this definition")  
Negative-binomial log probability mass function.

JAX implementation of [`scipy.stats.nbinom`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.nbinom.html#scipy.stats.nbinom "(in SciPy v1.19.0.dev)") `logpmf`.
...
[`jax.scipy.stats.nbinom.pmf()`](jax.scipy.stats.nbinom.pmf.html#jax.scipy.stats.nbinom.pmf "jax.scipy.stats.nbinom.pmf")

[](jax.scipy.stats.multivariate_normal.pdf.html "previous page")

previous

jax.scipy.stats.multivariate_normal.pdf

[](jax.scipy.stats.nbinom.pmf.html "next page")
