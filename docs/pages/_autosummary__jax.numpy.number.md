...
- [ .rst](../_sources/_autosummary/jax.numpy.number.rst "Download source file")
-  .pdf
...
- [`number`](#jax.numpy.number)
  - [`number.__init__()`](#jax.numpy.number.__init__)

# jax.numpy.number[\#](#jax-numpy-number "Link to this heading")

*class* jax.numpy.number[\#](#jax.numpy.number "Link to this definition")  
Abstract base class of all numeric scalar types.

\_\_init\_\_()[\#](#jax.numpy.number.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.numpy.number.__init__ "jax.numpy.number.__init__")() |  |
...
[](jax.numpy.not_equal.html "previous page")

previous

jax.numpy.not_equal

[](jax.numpy.object_.html "next page")
