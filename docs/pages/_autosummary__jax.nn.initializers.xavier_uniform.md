...
- [ .rst](../_sources/_autosummary/jax.nn.initializers.xavier_uniform.rst "Download source file")
-  .pdf
...
# jax.nn.initializers.xavier_uniform[\#](#jax-nn-initializers-xavier-uniform "Link to this heading")

jax.nn.initializers.xavier_uniform(*in_axis=-2*, *out_axis=-1*, *batch_axis=()*, *dtype=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/nn/initializers.py#L374-L409)[\#](#jax.nn.initializers.xavier_uniform "Link to this definition")  
...
[](jax.nn.initializers.xavier_normal.html "previous page")

previous

jax.nn.initializers.xavier_normal

[](jax.nn.initializers.zeros.html "next page")
