...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.pareto.sf.rst "Download source file")
-  .pdf
...
- [`sf()`](#jax.scipy.stats.pareto.sf)

# jax.scipy.stats.pareto.sf[\#](#jax-scipy-stats-pareto-sf "Link to this heading")

jax.scipy.stats.pareto.sf(*x*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/pareto.py#L234-L270)[\#](#jax.scipy.stats.pareto.sf "Link to this definition")  
Pareto survival function.

JAX implementation of [`scipy.stats.pareto`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.pareto.html#scipy.stats.pareto "(in SciPy v1.19.0.dev)") `sf`.
...
[](jax.scipy.stats.pareto.ppf.html "previous page")

previous

jax.scipy.stats.pareto.ppf

[](jax.scipy.stats.poisson.logpmf.html "next page")
