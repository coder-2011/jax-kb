...
- [ .rst](../_sources/_autosummary/jax.dtypes.bfloat16.rst "Download source file")
-  .pdf
...
- [`bfloat16`](#jax.dtypes.bfloat16)
  - [`bfloat16.__init__()`](#jax.dtypes.bfloat16.__init__)

# jax.dtypes.bfloat16[\#](#jax-dtypes-bfloat16 "Link to this heading")

*class* jax.dtypes.bfloat16[\#](#jax.dtypes.bfloat16 "Link to this definition")  
bfloat16 floating-point values

\_\_init\_\_()[\#](#jax.dtypes.bfloat16.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.dtypes.bfloat16.__init__ "jax.dtypes.bfloat16.__init__")() |  |
...
[](../jax.dtypes.html "previous page")

previous

`jax.dtypes` module

[](jax.dtypes.canonicalize_dtype.html "next page")
