...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.pareto.cdf.rst "Download source file")
-  .pdf
...
- [`cdf()`](#jax.scipy.stats.pareto.cdf)

# jax.scipy.stats.pareto.cdf[\#](#jax-scipy-stats-pareto-cdf "Link to this heading")

jax.scipy.stats.pareto.cdf(*x*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/pareto.py#L108-L149)[\#](#jax.scipy.stats.pareto.cdf "Link to this definition")  
Pareto cumulative distribution function.

JAX implementation of [`scipy.stats.pareto`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.pareto.html#scipy.stats.pareto "(in SciPy v1.19.0.dev)") `cdf`.
...
[](jax.scipy.stats.pareto.logsf.html "previous page")

previous

jax.scipy.stats.pareto.logsf

[](jax.scipy.stats.pareto.pdf.html "next page")
