...
- [ .md](../../_sources/pallas/design/async_note.md "Download source file")
-  .pdf
...
- [Background + Motivation](#background-motivation)
  - [XLA Async Decomposition](#xla-async-decomposition)
  - [Async ops inside kernels](#async-ops-inside-kernels)
- [How do we implement decomposed Pallas async operations (on TPU)?](#how-do-we-implement-decomposed-pallas-async-operations-on-tpu)
- [Why *doesn’t* this work?](#why-doesnt-this-work)
  - [Scheduling](#scheduling)
  - [Lifetimes](#lifetimes)
  - [Defensive copies](#defensive-copies)
    - [Background](#background)
    - [Copies with downstream ops](#copies-with-downstream-ops)
    - [Loop aliasing](#loop-aliasing)
    - [Passing futures across loop boundaries](#passing-futures-across-loop-boundaries)
  - [Putting it all together](#putting-it-all-together)
- [Revenge of the State](#revenge-of-the-state)
- [Conclusion](#conclusion)

# Pallas Async Operations[\#](#pallas-async-operations "Link to this heading")
...
### XLA Async Decomposition[\#](#xla-async-decomposition "Link to this heading")
...
### Async ops inside kernels[\#](#async-ops-inside-kernels "Link to this heading")
...
## How do we implement decomposed Pallas async operations (on TPU)?[\#](#how-do-we-implement-decomposed-pallas-async-operations-on-tpu "Link to this heading")
...
## Why *doesn’t* this work?[\#](#why-doesnt-this-work "Link to this heading")
...
### Lifetimes[\#](#lifetimes "Link to this heading")
...
### Defensive copies[\#](#defensive-copies "Link to this heading")
...
#### Copies with downstream ops[\#](#copies-with-downstream-ops "Link to this heading")
...
#### Loop aliasing[\#](#loop-aliasing "Link to this heading")
...
#### Passing futures across loop boundaries[\#](#passing-futures-across-loop-boundaries "Link to this heading")
...
## Revenge of the State[\#](#revenge-of-the-state "Link to this heading")
