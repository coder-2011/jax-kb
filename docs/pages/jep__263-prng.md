...
- [ .md](../_sources/jep/263-prng.md "Download source file")
-  .pdf
...
# JAX PRNG Design[\#](#jax-prng-design "Link to this heading")
...
> TLDR **JAX PRNG = [Threefry counter PRNG](https://thesalmons.org/john/random123/papers/random123sc11.pdf) + a functional array-oriented [splitting model](https://dl.acm.org/doi/10.1145/2503778.2503784)**
...
## Three programming models and toy example programs[\#](#three-programming-models-and-toy-example-programs "Link to this heading")
...
## More realistic example user programs[\#](#more-realistic-example-user-programs "Link to this heading")
...
## Tradeoffs and alternatives[\#](#tradeoffs-and-alternatives "Link to this heading")
...
[](2026-custom-derivatives.html "next page")
