...
- [ .rst](../_sources/_autosummary/jax.numpy.index_exp.rst "Download source file")
-  .pdf
...
- [`index_exp`](#jax.numpy.index_exp)

# jax.numpy.index_exp[\#](#jax-numpy-index-exp "Link to this heading")

jax.numpy.index_exp *= \<numpy.lib.\_index_tricks_impl.IndexExpression object\>*[\#](#jax.numpy.index_exp "Link to this definition")  
...
[`s_`](jax.numpy.s_.html#jax.numpy.s_ "jax.numpy.s_")  
...
[](jax.numpy.imag.html "previous page")

previous

jax.numpy.imag

[](jax.numpy.indices.html "next page")
