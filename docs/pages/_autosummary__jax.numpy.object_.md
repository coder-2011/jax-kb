...
- [ .rst](../_sources/_autosummary/jax.numpy.object_.rst "Download source file")
-  .pdf
...
- [`object_`](#jax.numpy.object_)
  - [`object_.__init__()`](#jax.numpy.object_.__init__)

# jax.numpy.object\_[\#](#jax-numpy-object "Link to this heading")

*class* jax.numpy.object\_(*value=None*, */*)[\#](#jax.numpy.object_ "Link to this definition")  
Any Python object.

Character code:  
`'O'`

\_\_init\_\_()[\#](#jax.numpy.object_.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.numpy.object_.__init__ "jax.numpy.object_.__init__")() |  |
...
[](jax.numpy.number.html "previous page")

previous

jax.numpy.number

[](jax.numpy.ogrid.html "next page")
