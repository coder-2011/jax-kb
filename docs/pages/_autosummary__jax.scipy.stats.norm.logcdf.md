...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.norm.logcdf.rst "Download source file")
-  .pdf
...
- [`logcdf()`](#jax.scipy.stats.norm.logcdf)

# jax.scipy.stats.norm.logcdf[\#](#jax-scipy-stats-norm-logcdf "Link to this heading")

jax.scipy.stats.norm.logcdf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/norm.py#L126-L159)[\#](#jax.scipy.stats.norm.logcdf "Link to this definition")  
Normal log cumulative distribution function.

JAX implementation of [`scipy.stats.norm`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.norm.html#scipy.stats.norm "(in SciPy v1.19.0.dev)") `logcdf`.
...
[](jax.scipy.stats.norm.cdf.html "previous page")

previous

jax.scipy.stats.norm.cdf

[](jax.scipy.stats.norm.ppf.html "next page")
