...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gumbel_l.logpdf.rst "Download source file")
-  .pdf
...
- [`logpdf()`](#jax.scipy.stats.gumbel_l.logpdf)

# jax.scipy.stats.gumbel_l.logpdf[\#](#jax-scipy-stats-gumbel-l-logpdf "Link to this heading")

jax.scipy.stats.gumbel_l.logpdf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gumbel_l.py#L25-L62)[\#](#jax.scipy.stats.gumbel_l.logpdf "Link to this definition")  
...
[](jax.scipy.stats.gamma.logsf.html "previous page")

previous

jax.scipy.stats.gamma.logsf

[](jax.scipy.stats.gumbel_l.pdf.html "next page")
