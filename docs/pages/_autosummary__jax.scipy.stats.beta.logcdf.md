...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.beta.logcdf.rst "Download source file")
-  .pdf
...
- [`logcdf()`](#jax.scipy.stats.beta.logcdf)

# jax.scipy.stats.beta.logcdf[\#](#jax-scipy-stats-beta-logcdf "Link to this heading")

jax.scipy.stats.beta.logcdf(*x*, *a*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/beta.py#L151-L184)[\#](#jax.scipy.stats.beta.logcdf "Link to this definition")  
Beta log cumulative distribution function.

JAX implementation of [`scipy.stats.beta`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.beta.html#scipy.stats.beta "(in SciPy v1.19.0.dev)") `logcdf`.

The cdf is defined as

\\f\_{cdf}(x, a, b) = \int\_{-\infty}^x f\_{pdf}(y, a, b)\mathrm{d}y\\

where \\f\_{pdf}\\ is the beta distribution probability density function, [`jax.scipy.stats.beta.pdf()`](jax.scipy.stats.beta.pdf.html#jax.scipy.stats.beta.pdf "jax.scipy.stats.beta.pdf").
...
[](jax.scipy.stats.beta.cdf.html "previous page")

previous

jax.scipy.stats.beta.cdf

[](jax.scipy.stats.beta.sf.html "next page")
