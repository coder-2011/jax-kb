...
- [ .rst](../_sources/_autosummary/jax.numpy.triu_indices.rst "Download source file")
-  .pdf
...
- [`triu_indices()`](#jax.numpy.triu_indices)

# jax.numpy.triu_indices[\#](#jax-numpy-triu-indices "Link to this heading")

jax.numpy.triu_indices(*n*, *k=0*, *m=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/numpy/lax_numpy.py#L6831-L6888)[\#](#jax.numpy.triu_indices "Link to this definition")  
Return the indices of upper triangle of an array of size `(n,`` ``m)`.

JAX implementation of [`numpy.triu_indices()`](https://numpy.org/doc/stable/reference/generated/numpy.triu_indices.html#numpy.triu_indices "(in NumPy v2.4)").

Parameters:  
- **n** (*DimSize*) – int. Number of rows of the array for which the indices are returned.

- **k** (*DimSize*) – optional, int, default=0. Specifies the sub-diagonal on and above which the indices of upper triangle are returned. `k=0` refers to main diagonal, `k<0` refers to sub-diagonal below the main diagonal and `k>0` refers to sub-diagonal above the main diagonal.
...
[](jax.numpy.triu.html "previous page")

previous

jax.numpy.triu

[](jax.numpy.triu_indices_from.html "next page")
