...
- [ .md](_sources/investigating_a_regression.md "Download source file")
-  .pdf
...
- [Steps](#steps)
- [Nightly investigation](#nightly-investigation)
- [Hourly investigation](#hourly-investigation)
- [Final verification](#final-verification)
- [Can this be improved?](#can-this-be-improved)

# Investigating a regression[\#](#investigating-a-regression "Link to this heading")
...
This document explains how we identified the commit that caused a [15% performance regression](https://github.com/jax-ml/jax/issues/17686).
...
## Nightly investigation[\#](#nightly-investigation "Link to this heading")

This can be done by using the [NVIDIA JAX-Toolbox nightly containers](https://github.com/NVIDIA/JAX-Toolbox).
...
## Hourly investigation[\#](#hourly-investigation "Link to this heading")
...
## Final verification[\#](#final-verification "Link to this heading")
...
## Can this be improved?[\#](#can-this-be-improved "Link to this heading")
...
[](developer.html "previous page")

previous

Building from source

[](autodidax.html "next page")
