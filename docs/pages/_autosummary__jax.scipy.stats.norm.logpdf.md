...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.norm.logpdf.rst "Download source file")
-  .pdf
...
# jax.scipy.stats.norm.logpdf[\#](#jax-scipy-stats-norm-logpdf "Link to this heading")

jax.scipy.stats.norm.logpdf(*x*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/norm.py#L25-L58)[\#](#jax.scipy.stats.norm.logpdf "Link to this definition")  
Normal log probability distribution function.

JAX implementation of [`scipy.stats.norm`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.norm.html#scipy.stats.norm "(in SciPy v1.19.0.dev)") `logpdf`.
...
[](jax.scipy.stats.nbinom.pmf.html "previous page")

previous

jax.scipy.stats.nbinom.pmf

[](jax.scipy.stats.norm.pdf.html "next page")
