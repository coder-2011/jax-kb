...
- [ .rst](../_sources/_autosummary/jax.lax.scatter_sub.rst "Download source file")
-  .pdf
...
- [`scatter_sub()`](#jax.lax.scatter_sub)

# jax.lax.scatter_sub[\#](#jax-lax-scatter-sub "Link to this heading")

jax.lax.scatter_sub(*operand*, *scatter_indices*, *updates*, *dimension_numbers*, *\**, *indices_are_sorted=False*, *unique_indices=False*, *mode=None*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/lax/slicing.py#L559-L621)[\#](#jax.lax.scatter_sub "Link to this definition")  
Scatter-sub operator.

Wraps [XLA’s Scatter operator](https://www.openxla.org/xla/operation_semantics#scatter), where subtraction is used to combine updates and values from operand.
...
Returns:  
An array containing the difference between operand and the scattered updates.

Return type:  
[Array](jax.Array.html#jax.Array "jax.Array")

[](jax.lax.scatter_mul.html "previous page")

previous

jax.lax.scatter_mul

[](jax.lax.shift_left.html "next page")
