...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.pareto.pdf.rst "Download source file")
-  .pdf
...
- [`pdf()`](#jax.scipy.stats.pareto.pdf)

# jax.scipy.stats.pareto.pdf[\#](#jax-scipy-stats-pareto-pdf "Link to this heading")

jax.scipy.stats.pareto.pdf(*x*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/pareto.py#L70-L106)[\#](#jax.scipy.stats.pareto.pdf "Link to this definition")  
Pareto probability distribution function.

JAX implementation of [`scipy.stats.pareto`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.pareto.html#scipy.stats.pareto "(in SciPy v1.19.0.dev)") `pdf`.
...
[](jax.scipy.stats.pareto.cdf.html "previous page")

previous

jax.scipy.stats.pareto.cdf

[](jax.scipy.stats.pareto.ppf.html "next page")
