...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.beta.sf.rst "Download source file")
-  .pdf
...
- [`sf()`](#jax.scipy.stats.beta.sf)

# jax.scipy.stats.beta.sf[\#](#jax-scipy-stats-beta-sf "Link to this heading")

jax.scipy.stats.beta.sf(*x*, *a*, *b*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/beta.py#L186-L228)[\#](#jax.scipy.stats.beta.sf "Link to this definition")  
Beta distribution survival function.

JAX implementation of [`scipy.stats.beta`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.beta.html#scipy.stats.beta "(in SciPy v1.19.0.dev)") `sf`.
...
[](jax.scipy.stats.beta.logcdf.html "previous page")

previous

jax.scipy.stats.beta.logcdf

[](jax.scipy.stats.beta.logsf.html "next page")
