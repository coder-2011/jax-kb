...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gamma.sf.rst "Download source file")
-  .pdf
...
- [`sf()`](#jax.scipy.stats.gamma.sf)

# jax.scipy.stats.gamma.sf[\#](#jax-scipy-stats-gamma-sf "Link to this heading")

jax.scipy.stats.gamma.sf(*x*, *a*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gamma.py#L172-L205)[\#](#jax.scipy.stats.gamma.sf "Link to this definition")  
Gamma survival function.

JAX implementation of [`scipy.stats.gamma`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.gamma.html#scipy.stats.gamma "(in SciPy v1.19.0.dev)") `sf`.
...
[](jax.scipy.stats.gamma.logcdf.html "previous page")

previous

jax.scipy.stats.gamma.logcdf

[](jax.scipy.stats.gamma.logsf.html "next page")
