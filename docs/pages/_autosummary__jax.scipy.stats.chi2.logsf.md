...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.chi2.logsf.rst "Download source file")
-  .pdf
...
- [`logsf()`](#jax.scipy.stats.chi2.logsf)

# jax.scipy.stats.chi2.logsf[\#](#jax-scipy-stats-chi2-logsf "Link to this heading")

jax.scipy.stats.chi2.logsf(*x*, *df*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/chi2.py#L236-L268)[\#](#jax.scipy.stats.chi2.logsf "Link to this definition")  
Chi-square log survival function.

JAX implementation of [`scipy.stats.chi2`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.chi2.html#scipy.stats.chi2 "(in SciPy v1.19.0.dev)") `logsf`.

The survival function is defined as

\\f\_{sf}(x, k) = 1 - f\_{cdf}(x, k)\\

where \\f\_{cdf}(x, k)\\ is the cumulative distribution function, [`jax.scipy.stats.chi2.cdf()`](jax.scipy.stats.chi2.cdf.html#jax.scipy.stats.chi2.cdf "jax.scipy.stats.chi2.cdf"). JAX follows the scipy convention of using `df` to denote degrees of freedom.
...
[](jax.scipy.stats.chi2.sf.html "previous page")

previous

jax.scipy.stats.chi2.sf

[](jax.scipy.stats.dirichlet.logpdf.html "next page")
