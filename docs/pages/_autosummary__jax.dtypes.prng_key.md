...
- [ .rst](../_sources/_autosummary/jax.dtypes.prng_key.rst "Download source file")
-  .pdf
...
- [`prng_key`](#jax.dtypes.prng_key)
  - [`prng_key.__init__()`](#jax.dtypes.prng_key.__init__)

# jax.dtypes.prng_key[\#](#jax-dtypes-prng-key "Link to this heading")

*class* jax.dtypes.prng_key[\#](#jax.dtypes.prng_key "Link to this definition")  
...
\_\_init\_\_()[\#](#jax.dtypes.prng_key.__init__ "Link to this definition")  

Methods

|  |  |
|----|----|
| [`__init__`](#jax.dtypes.prng_key.__init__ "jax.dtypes.prng_key.__init__")() |  |
...
[](jax.dtypes.issubdtype.html "previous page")

previous

jax.dtypes.issubdtype

[](jax.dtypes.result_type.html "next page")
