...
- [Pallas Design Notes](index.html)
- Pallas Design

[ ](https://github.com/jax-ml/jax "Source repository")

- [ .md](../../_sources/pallas/design/design.md "Download source file")
-  .pdf
...
# Pallas Design[\#](#pallas-design "Link to this heading")
...
![Pallas lowering path](../../_images/pallas_flow.png) Visualization of Pallas lowering paths

## Pallas: Extending JAX for kernels[\#](#pallas-extending-jax-for-kernels "Link to this heading")
...
#### Reading from/writing into Refs[\#](#reading-from-writing-into-refs "Link to this heading")
...
### Extending JAX with new Pallas primitives[\#](#extending-jax-with-new-pallas-primitives "Link to this heading")
...
#### `pallas.load` and `pallas.store`[\#](#pallas-load-and-pallas-store "Link to this heading")
...
#### `pallas.program_id` and `pallas.num_programs`[\#](#pallas-program-id-and-pallas-num-programs "Link to this heading")
...
#### Using a subset of JAX primitives in Pallas[\#](#using-a-subset-of-jax-primitives-in-pallas "Link to this heading")
...
### Executing Pallas kernels with `pallas_call`[\#](#executing-pallas-kernels-with-pallas-call "Link to this heading")
...
#### Transformation functions[\#](#transformation-functions "Link to this heading")
...
### Immediate benefits of Pallas as a front-end[\#](#immediate-benefits-of-pallas-as-a-front-end "Link to this heading")

By offering a JAX front-end for kernel writing, we can immediately reap some benefits.

#### More flexible front end[\#](#more-flexible-front-end "Link to this heading")
...
#### Emulation mode[\#](#emulation-mode "Link to this heading")
...
### GPU Examples[\#](#gpu-examples "Link to this heading")
...
#### Templated matmul[\#](#templated-matmul "Link to this heading")
...
### Lowering Pallas[\#](#lowering-pallas "Link to this heading")
...
#### Lowering Pallas to Triton for GPU[\#](#lowering-pallas-to-triton-for-gpu "Link to this heading")
...
#### Lowering Pallas to Mosaic for TPU[\#](#lowering-pallas-to-mosaic-for-tpu "Link to this heading")
...
### Transforming Pallas[\#](#transforming-pallas "Link to this heading")
...
#### `vmap-of-pallas_call`[\#](#vmap-of-pallas-call "Link to this heading")
...
#### `grad-of-pallas_call`[\#](#grad-of-pallas-call "Link to this heading")

`grad` of `pallas_call` enables automatic differentiation of kernels. `jax.grad` breaks down into applications of three distinct transforms: `jvp`, `partial_eval` and `transpose`. In principle, we can reuse most of JAX’s infrastructure when implementing these rules for `pallas_call` (since it behaves much like existing JAX higher order primitives).
...
#### Other transformations[\#](#other-transformations "Link to this heading")
