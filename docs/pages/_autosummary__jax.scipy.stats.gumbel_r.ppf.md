...
- [ .rst](../_sources/_autosummary/jax.scipy.stats.gumbel_r.ppf.rst "Download source file")
-  .pdf
...
- [`ppf()`](#jax.scipy.stats.gumbel_r.ppf)

# jax.scipy.stats.gumbel_r.ppf[\#](#jax-scipy-stats-gumbel-r-ppf "Link to this heading")

jax.scipy.stats.gumbel_r.ppf(*p*, *loc=0*, *scale=1*)[\[source\]](https://github.com/jax-ml/jax/blob/main/jax/_src/scipy/stats/gumbel_r.py#L159-L195)[\#](#jax.scipy.stats.gumbel_r.ppf "Link to this definition")  
Gumbel Distribution (Right Skewed) percent point function.

JAX implementation of [`scipy.stats.gumbel_r`](https://scipy.github.io/devdocs/reference/generated/scipy.stats.gumbel_r.html#scipy.stats.gumbel_r "(in SciPy v1.19.0.dev)") `ppf`.
...
[](jax.scipy.stats.gumbel_r.logsf.html "previous page")

previous

jax.scipy.stats.gumbel_r.logsf

[](jax.scipy.stats.gennorm.cdf.html "next page")
